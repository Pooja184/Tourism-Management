...
const AddTours = () => {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 bg-white shadow-lg rounded-lg p-8">
      <h2 className="text-2xl font-bold mb-6 text-gray-800 text-center">Add New Tour</h2>
      ...
      {success && <p className="mt-4 text-green-600 font-medium">✅ Tour added successfully!</p>}
      {error && <p className="mt-4 text-red-600 font-medium">❌ {error.message || error}</p>}
    </div>
  );
};
